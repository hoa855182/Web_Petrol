                            ...
                            <form class="form" method="post" novalidate>
                                <div class="form-row">
                                    <div class="col-md-6 ">
                                        ...
                                        <input style="width: 420px; margin-left: 200px;" type="text" class="form-control" id="validationCustom03" type="text"  name="catId" placeholder="ID"  required>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 ">
                                        ...
                                        <input style="width: 420px; margin-left: 200px;" type="text" class="form-control" id="validationCustom03" type="text"  name="catpid" placeholder="Category Id"  required>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 ">
                                        ...
                                        <input style="width: 420px; margin-left: 200px;" type="text" class="form-control" id="validationCustom03" type="text" name="catpname" placeholder="ProductName"  required>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 ">
                                        ...
                                        <input style="width: 420px; margin-left: 200px;" type="text" class="form-control" id="validationCustom03" type="text" name="catpprice" placeholder="Price"  required>
                                        <div class="invalid-feedback">Please provide a valid category price.</div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-6 ">
                                        <label for="validationCustom03" style="color:white;margin-left:210px;">Status Product</label>
                                        <input style="width: 420px; margin-left: 200px;" type="text" class="form-control" id="validationCustom03" type="text" name="catpstaut" placeholder="StatusProduct"  required>
                                        <div class="invalid-feedback">Please provide a valid category status.</div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-6 ">
                                        <label for="validationCustom03" style="color:white;margin-left:210px;">Import Number</label>
                                        <input style="width: 420px; margin-left: 200px;" type="text" class="form-control" id="validationCustom03" type="text"  name="catimpt" placeholder="Import" required>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <label for="validationCustom03" style="color:white;margin-left:210px;">Export Number</label>
                                        <input style="width: 420px; margin-left: 200px;" type="text" class="form-control" id="validationCustom03" type="text" name="catexpt"  placeholder="Export" required>
