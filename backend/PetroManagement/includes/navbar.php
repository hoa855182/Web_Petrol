<nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar">
            ...
            <a class="navbar-brand" href="../dasboard.php">Petro Management
            </a>
                    ...
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar">
                                    <img src="../resources/img/logo.png" alt="user" class="avatar-img rounded-circle">
                                </div>
...
$query=mysqli_query($con,"select AdminName from AdminUser where id='$adminid'");
